...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <!-- Contenedor principal con fondo azul oscuro futurista -->
    <div class="container mt-4">
        <div class="row justify-content-center">
            <div class="col-6">
                <div class="card" style="border: 2px solid #1b1f3a; padding: 20px; border-radius: 10px; background-color: transparent;">
                    <div class="card-body">
                        <h3 class="mb-3" style="border-bottom: 2px solid #00c6ff; padding-bottom: 8px;">Creá tu perfil Trainee</h3>
                        
                        <div class="mb-3">
                            <asp:Label Text="Correo electrónico" runat="server" CssClass="" Font-Size="Larger" Font-Bold="true" />
                        ...
                        <div class="mb-3">
                            <asp:Label Text="Contraseña" runat="server" CssClass="" Font-Size="Larger" Font-Bold="true" />
